// contract.rs
use crate::msg::{ExecuteContractMsg, InstantiateMsg, QueryMsg, QueryResponse};
use crate::state::STORED_DATA;
use cosmwasm_std::{
    attr, entry_point, to_json_binary, to_json_string, Binary, Deps, DepsMut, Env, MessageInfo,
...
pub fn query_pep_decrypt(
    ...
    // Send the query
    let raw_response: Binary = deps.querier.query_grpc(
        "/fairyring.pep.Query/DecryptData".to_string(),
