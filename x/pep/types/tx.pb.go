...
type EncrytedDataType int32

const (
	EncrytedDataType_DATA        EncrytedDataType = 0
	EncrytedDataType_TRANSACTION EncrytedDataType = 1
)

var EncrytedDataType_name = map[int32]string{
	0: "DATA",
	1: "TRANSACTION",
}

var EncrytedDataType_value = map[string]int32{
	"DATA":        0,
	"TRANSACTION": 1,
}

func (x EncrytedDataType) String() string {
	return proto.EnumName(EncrytedDataType_name, int32(x))
}

func (EncrytedDataType) EnumDescriptor() ([]byte, []int) {
...
type MsgSubmitGeneralEncryptedData struct {
	Creator  string           `protobuf:"bytes,1,opt,name=creator,proto3" json:"creator,omitempty"`
	Data     string           `protobuf:"bytes,2,opt,name=data,proto3" json:"data,omitempty"`
	ReqId    string           `protobuf:"bytes,3,opt,name=req_id,json=reqId,proto3" json:"req_id,omitempty"`
	DataType EncrytedDataType `protobuf:"varint,4,opt,name=data_type,json=dataType,proto3,enum=fairyring.pep.EncrytedDataType" json:"data_type,omitempty"`
}

func (m *MsgSubmitGeneralEncryptedData) Reset()         { *m = MsgSubmitGeneralEncryptedData{} }
func (m *MsgSubmitGeneralEncryptedData) String() string { return proto.CompactTextString(m) }
func (*MsgSubmitGeneralEncryptedData) ProtoMessage()    {}
func (*MsgSubmitGeneralEncryptedData) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6953e463911e1ec, []int{1}
}
func (m *MsgSubmitGeneralEncryptedData) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MsgSubmitGeneralEncryptedData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MsgSubmitGeneralEncryptedData.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MsgSubmitGeneralEncryptedData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MsgSubmitGeneralEncryptedData.Merge(m, src)
}
func (m *MsgSubmitGeneralEncryptedData) XXX_Size() int {
	return m.Size()
}
func (m *MsgSubmitGeneralEncryptedData) XXX_DiscardUnknown() {
	xxx_messageInfo_MsgSubmitGeneralEncryptedData.DiscardUnknown(m)
}

var xxx_messageInfo_MsgSubmitGeneralEncryptedData proto.InternalMessageInfo

func (m *MsgSubmitGeneralEncryptedData) GetCreator() string {
	if m != nil {
		return m.Creator
	}
	return ""
...
func (m *MsgSubmitGeneralEncryptedData) GetData() string {
	if m != nil {
		return m.Data
	}
	return ""
...
func (m *MsgSubmitGeneralEncryptedData) GetReqId() string {
	if m != nil {
		return m.ReqId
	}
	return ""
...
func (m *MsgSubmitGeneralEncryptedData) GetDataType() EncrytedDataType {
	if m != nil {
		return m.DataType
	}
	return EncrytedDataType_DATA
}
...
func init() {
	proto.RegisterEnum("fairyring.pep.EncrytedDataType", EncrytedDataType_name, EncrytedDataType_value)
	proto.RegisterType((*MsgSubmitEncryptedTx)(nil), "fairyring.pep.MsgSubmitEncryptedTx")
	proto.RegisterType((*MsgSubmitGeneralEncryptedData)(nil), "fairyring.pep.MsgSubmitGeneralEncryptedData")
...
var fileDescriptor_f6953e463911e1ec = []byte{
	...
	,
}
...
type MsgClient interface {
	...
	SubmitGeneralEncryptedData(ctx context.Context, in *MsgSubmitGeneralEncryptedData, opts ...grpc.CallOption) (*MsgSubmitEncryptedTxResponse, error)
...
func (c *msgClient) SubmitGeneralEncryptedData(ctx context.Context, in *MsgSubmitGeneralEncryptedData, opts ...grpc.CallOption) (*MsgSubmitEncryptedTxResponse, error) {
	out := new(MsgSubmitEncryptedTxResponse)
	err := c.cc.Invoke(ctx, "/fairyring.pep.Msg/SubmitGeneralEncryptedData", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MsgServer interface {
	...
	SubmitGeneralEncryptedData(context.Context, *MsgSubmitGeneralEncryptedData) (*MsgSubmitEncryptedTxResponse, error)
	// this line is used by starport scaffolding # proto/tx/rpc
...
func (*UnimplementedMsgServer) SubmitGeneralEncryptedData(ctx context.Context, req *MsgSubmitGeneralEncryptedData) (*MsgSubmitEncryptedTxResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubmitGeneralEncryptedData not implemented")
}
...
func _Msg_SubmitGeneralEncryptedData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MsgSubmitGeneralEncryptedData)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MsgServer).SubmitGeneralEncryptedData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fairyring.pep.Msg/SubmitGeneralEncryptedData",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MsgServer).SubmitGeneralEncryptedData(ctx, req.(*MsgSubmitGeneralEncryptedData))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SubmitGeneralEncryptedData",
			Handler:    _Msg_SubmitGeneralEncryptedData_Handler,
		},
		{
...
func (m *MsgSubmitGeneralEncryptedData) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MsgSubmitGeneralEncryptedData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MsgSubmitGeneralEncryptedData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MsgSubmitGeneralEncryptedData) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MsgSubmitGeneralEncryptedData) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MsgSubmitGeneralEncryptedData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MsgSubmitGeneralEncryptedData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DataType |= EncrytedDataType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
