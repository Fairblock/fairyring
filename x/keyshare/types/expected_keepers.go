...
type PepKeeper interface {
	...
	SetEntry(ctx context.Context, val peptypes.IdentityExecutionQueue)
	GetEntry(ctx context.Context, reqID string) (val peptypes.IdentityExecutionQueue, found bool)
	RemoveEntry(ctx context.Context, reqID string)
	GetAllGenEncTxEntry(ctx context.Context) (list []peptypes.IdentityExecutionQueue)
	...
	GetExecutionQueueEntry(ctx context.Context, reqID string) (val peptypes.IdentityExecutionQueue, found bool)
	SetExecutionQueueEntry(ctx context.Context, val peptypes.IdentityExecutionQueue)
	RemoveExecutionQueueEntry(ctx context.Context, reqID string)
	GetAllGenEncTxExecutionQueueEntry(ctx context.Context) (list []peptypes.IdentityExecutionQueue)
	...
	GetPrivateRequestQueueEntry(ctx context.Context, reqID string) (val commontypes.RequestEncryptedKeyshare, found bool)
	SetPrivateReqQueueEntry(ctx context.Context, val commontypes.RequestEncryptedKeyshare)
	RemovePrivateReqQueueEntry(ctx context.Context, reqID string)
	GetAllPrivateReqQueueEntry(ctx context.Context) (list []commontypes.RequestEncryptedKeyshare)
