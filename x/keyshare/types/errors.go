...
var (
	...
	ErrInvalidKeyShareLength      = sdkerrors.Register(ModuleName, 1117, "invalid KeyShare length")
	ErrInvalidPubKeyLength        = sdkerrors.Register(ModuleName, 1118, "invalid PubKey length")
	ErrInvalidPubKey              = sdkerrors.Register(ModuleName, 1119, "invalid PubKey")
	ErrInvalidCommitment          = sdkerrors.Register(ModuleName, 1120, "invalid commitment")
	ErrInvalidCommitmentLength    = sdkerrors.Register(ModuleName, 1121, "invalid commitment length")
)
