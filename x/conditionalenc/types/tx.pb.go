...
func (m *MsgCreateAggregatedKeyShare) GetCondition() string {
	if m != nil {
		return m.Condition
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*MsgCreateAggregatedKeyShare)(nil), "fairyring.Conditionalenc.MsgCreateAggregatedKeyShare")
	proto.RegisterType((*MsgCreateAggregatedKeyShareResponse)(nil), "fairyring.Conditionalenc.MsgCreateAggregatedKeyShareResponse")
}
...
func (c *msgClient) CreateAggregatedKeyShare(ctx context.Context, in *MsgCreateAggregatedKeyShare, opts ...grpc.CallOption) (*MsgCreateAggregatedKeyShareResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/fairyring.Conditionalenc.Msg/CreateAggregatedKeyShare", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateAggregatedKeyShare_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fairyring.Conditionalenc.Msg/CreateAggregatedKeyShare",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
