...
func (m *AggregatedKeyShare) GetCondition() string {
	if m != nil {
		return m.Condition
	}
	return ""
...
func init() {
	proto.RegisterType((*AggregatedKeyShare)(nil), "fairyring.Conditionalenc.AggregatedKeyShare")
}
...
func (m *AggregatedKeyShare) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Condition) > 0 {
		...
		i = encodeVarintAggregatedKeyShare(dAtA, i, uint64(len(m.Condition)))
		i--
		dAtA[i] = 0xa
	}
