...
func (m *FairblockTx) GetChainId() string {
	if m != nil {
		return m.ChainId
	}
	return ""
...
var fileDescriptor_7f704434669377b5 = []byte{
	...
	,
}
...
func (m *FairblockTx) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ChainId) > 0 {
		...
		i = encodeVarintFairblockTx(dAtA, i, uint64(len(m.ChainId)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Nonce != 0 {
