...
// ConsensusVersion defines the current x/zkp module consensus version.
...
// ZKP queries are only accessible via CosmWasm contracts, not via REST API.
func (AppModuleBasic) RegisterGRPCGatewayRoutes(clientCtx client.Context, mux *runtime.ServeMux) {
	// ZKP verification queries are intentionally not exposed via REST API
	// They are only accessible through CosmWasm contracts via Stargate queries
}
