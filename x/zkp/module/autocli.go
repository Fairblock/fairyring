...
//
// Only TrustedContracts is exposed as a public CLI query. The proof verification
// RPCs stay intentionally hidden from the CLI because they are meant to be
// called only through the CosmWasm trusted-contract query path.
