...
const (
	...
	Query_RegisteredBidders_FullMethodName = "/fairyring.auction.Query/RegisteredBidders"
)
...
func (c *queryClient) RegisteredBidders(ctx context.Context, in *QueryRegisteredBiddersRequest, opts ...grpc.CallOption) (*QueryRegisteredBiddersResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_RegisteredBidders_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) RegisteredBidders(context.Context, *QueryRegisteredBiddersRequest) (*QueryRegisteredBiddersResponse, error) {
...
func _Query_RegisteredBidders_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Query_RegisteredBidders_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
