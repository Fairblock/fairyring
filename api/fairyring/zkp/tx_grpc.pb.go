...
const (
	Msg_UpdateParams_FullMethodName          = "/fairyring.zkp.Msg/UpdateParams"
	Msg_AddTrustedContract_FullMethodName    = "/fairyring.zkp.Msg/AddTrustedContract"
	Msg_RemoveTrustedContract_FullMethodName = "/fairyring.zkp.Msg/RemoveTrustedContract"
)
...
func (c *msgClient) AddTrustedContract(ctx context.Context, in *MsgAddTrustedContract, opts ...grpc.CallOption) (*MsgAddTrustedContractResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_AddTrustedContract_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RemoveTrustedContract(ctx context.Context, in *MsgRemoveTrustedContract, opts ...grpc.CallOption) (*MsgRemoveTrustedContractResponse, error) {
	...
	err := c.cc.Invoke(ctx, Msg_RemoveTrustedContract_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AddTrustedContract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_AddTrustedContract_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RemoveTrustedContract_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Msg_RemoveTrustedContract_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
