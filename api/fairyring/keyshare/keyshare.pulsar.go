...
var (
	...
	fd_ValidatorEncryptedKeyshare_secp_pubkey           protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_ValidatorEncryptedKeyshare_secp_pubkey = md_ValidatorEncryptedKeyshare.Fields().ByName("secp_pubkey")
}
...
func (x *fastReflection_ValidatorEncryptedKeyshare) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.SecpPubkey != "" {
		...
		if !f(fd_ValidatorEncryptedKeyshare_secp_pubkey, value) {
			return
		}
	}
}
...
func (x *fastReflection_ValidatorEncryptedKeyshare) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "fairyring.keyshare.ValidatorEncryptedKeyshare.identity":
		return x.Identity != ""
	case "fairyring.keyshare.ValidatorEncryptedKeyshare.secp_pubkey":
		return x.SecpPubkey != ""
	default:
		if fd.IsExtension() {
...
func (x *fastReflection_ValidatorEncryptedKeyshare) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "fairyring.keyshare.ValidatorEncryptedKeyshare.secp_pubkey":
		panic(fmt.Errorf("field secp_pubkey of message fairyring.keyshare.ValidatorEncryptedKeyshare is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.keyshare.ValidatorEncryptedKeyshare"))
		}
...
func (x *ValidatorEncryptedKeyshare) GetSecpPubkey() string {
	if x != nil {
		return x.SecpPubkey
	}
	return ""
...
var file_fairyring_keyshare_keyshare_proto_rawDesc = []byte{
	...
	0x6b, 0x48, 0x65, 0x69, 0x67, 0x68, 0x74, 0x22, 0xbb, 0x02, 0x0a, 0x1a, 0x56, 0x61, 0x6c, 0x69,
	...
	0x74, 0x69, 0x74, 0x79, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x65, 0x63, 0x70, 0x5f, 0x70, 0x75, 0x62,
	0x6b, 0x65, 0x79, 0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x73, 0x65, 0x63, 0x70, 0x50,
	0x75, 0x62, 0x6b, 0x65, 0x79, 0x42, 0xb5, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x66, 0x61,
	0x69, 0x72, 0x79, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x6b, 0x65, 0x79, 0x73, 0x68, 0x61, 0x72, 0x65,
	0x42, 0x0d, 0x4b, 0x65, 0x79, 0x73, 0x68, 0x61, 0x72, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50,
