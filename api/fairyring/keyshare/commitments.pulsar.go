...
var _ protoreflect.List = (*_Commitments_1_list)(nil)

type _Commitments_1_list struct {
	list *[]string
}

func (x *_Commitments_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_Commitments_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfString((*x.list)[i])
}

func (x *_Commitments_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_Commitments_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.String()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_Commitments_1_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message Commitments at list field Commitments as it is not of Message kind"))
}

func (x *_Commitments_1_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_Commitments_1_list) NewElement() protoreflect.Value {
	v := ""
	return protoreflect.ValueOfString(v)
}

func (x *_Commitments_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_Commitments             protoreflect.MessageDescriptor
	fd_Commitments_commitments protoreflect.FieldDescriptor
)

func init() {
	file_fairyring_keyshare_commitments_proto_init()
	md_Commitments = File_fairyring_keyshare_commitments_proto.Messages().ByName("Commitments")
	fd_Commitments_commitments = md_Commitments.Fields().ByName("commitments")
}
...
func (x *Commitments) slowProtoReflect() protoreflect.Message {
	mi := &file_fairyring_keyshare_commitments_proto_msgTypes[0]
...
func (x *fastReflection_Commitments) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Commitments) != 0 {
		value := protoreflect.ValueOfList(&_Commitments_1_list{list: &x.Commitments})
		if !f(fd_Commitments_commitments, value) {
			return
		}
	}
}
...
func (x *fastReflection_Commitments) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "fairyring.keyshare.Commitments.commitments":
		return len(x.Commitments) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.keyshare.Commitments"))
		}
		panic(fmt.Errorf("message fairyring.keyshare.Commitments does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Commitments) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "fairyring.keyshare.Commitments.commitments":
		if len(x.Commitments) == 0 {
			return protoreflect.ValueOfList(&_Commitments_1_list{})
		}
		listValue := &_Commitments_1_list{list: &x.Commitments}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.keyshare.Commitments"))
		}
		panic(fmt.Errorf("message fairyring.keyshare.Commitments does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Commitments) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "fairyring.keyshare.Commitments.commitments":
		...
		value := &_Commitments_1_list{list: &x.Commitments}
...
func (x *fastReflection_Commitments) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "fairyring.keyshare.Commitments.commitments":
		list := []string{}
		return protoreflect.ValueOfList(&_Commitments_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.keyshare.Commitments"))
		}
...
func (x *fastReflection_Commitments) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in fairyring.keyshare.Commitments", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Commitments) Descriptor() ([]byte, []int) {
	return file_fairyring_keyshare_commitments_proto_rawDescGZIP(), []int{0}
}
...
var file_fairyring_keyshare_commitments_proto_rawDesc = []byte{
	,
...
var (
	file_fairyring_keyshare_commitments_proto_rawDescOnce sync.Once
	file_fairyring_keyshare_commitments_proto_rawDescData = file_fairyring_keyshare_commitments_proto_rawDesc
)

func file_fairyring_keyshare_commitments_proto_rawDescGZIP() []byte {
	file_fairyring_keyshare_commitments_proto_rawDescOnce.Do(func() {
		file_fairyring_keyshare_commitments_proto_rawDescData = protoimpl.X.CompressGZIP(file_fairyring_keyshare_commitments_proto_rawDescData)
	})
	return file_fairyring_keyshare_commitments_proto_rawDescData
}

var file_fairyring_keyshare_commitments_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_fairyring_keyshare_commitments_proto_goTypes = []interface{}{
	(*Commitments)(nil), // 0: fairyring.keyshare.Commitments
}
var file_fairyring_keyshare_commitments_proto_depIdxs = []int32{
...
func init() { file_fairyring_keyshare_commitments_proto_init() }
func file_fairyring_keyshare_commitments_proto_init() {
	if File_fairyring_keyshare_commitments_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_fairyring_keyshare_commitments_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_fairyring_keyshare_commitments_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_fairyring_keyshare_commitments_proto_goTypes,
		DependencyIndexes: file_fairyring_keyshare_commitments_proto_depIdxs,
		MessageInfos:      file_fairyring_keyshare_commitments_proto_msgTypes,
	}.Build()
	File_fairyring_keyshare_commitments_proto = out.File
	file_fairyring_keyshare_commitments_proto_rawDesc = nil
	file_fairyring_keyshare_commitments_proto_goTypes = nil
	file_fairyring_keyshare_commitments_proto_depIdxs = nil
}
