...
var (
	...
	fd_AuthorizedAddress_isAuthorized protoreflect.FieldDescriptor
	fd_AuthorizedAddress_authorizedBy protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_AuthorizedAddress_isAuthorized = md_AuthorizedAddress.Fields().ByName("isAuthorized")
	fd_AuthorizedAddress_authorizedBy = md_AuthorizedAddress.Fields().ByName("authorizedBy")
}
...
func (x *fastReflection_AuthorizedAddress) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.IsAuthorized != false {
		...
		if !f(fd_AuthorizedAddress_isAuthorized, value) {
			return
		}
	}
	if x.AuthorizedBy != "" {
		value := protoreflect.ValueOfString(x.AuthorizedBy)
		if !f(fd_AuthorizedAddress_authorizedBy, value) {
			return
		}
	}
}
...
func (x *fastReflection_AuthorizedAddress) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "fairyring.keyshare.AuthorizedAddress.target":
		return x.Target != ""
	case "fairyring.keyshare.AuthorizedAddress.isAuthorized":
		return x.IsAuthorized != false
	case "fairyring.keyshare.AuthorizedAddress.authorizedBy":
...
func (x *fastReflection_AuthorizedAddress) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "fairyring.keyshare.AuthorizedAddress.isAuthorized":
		panic(fmt.Errorf("field isAuthorized of message fairyring.keyshare.AuthorizedAddress is not mutable"))
	case "fairyring.keyshare.AuthorizedAddress.authorizedBy":
		panic(fmt.Errorf("field authorizedBy of message fairyring.keyshare.AuthorizedAddress is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.keyshare.AuthorizedAddress"))
		}
...
var file_fairyring_keyshare_authorized_address_proto_rawDesc = []byte{
	...
	0x65, 0x22, 0x73, 0x0a, 0x11, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x65, 0x64, 0x41,
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x12, 0x22,
	...
	0x65, 0x64, 0x12, 0x22, 0x0a, 0x0c, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x65, 0x64,
	0x42, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72,
	0x69, 0x7a, 0x65, 0x64, 0x42, 0x79, 0x42, 0xbe, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d, 0x2e, 0x66,
	0x61, 0x69, 0x72, 0x79, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x6b, 0x65, 0x79, 0x73, 0x68, 0x61, 0x72,
	0x65, 0x42, 0x16, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x7a, 0x65, 0x64, 0x41, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x23, 0x63, 0x6f, 0x73,
