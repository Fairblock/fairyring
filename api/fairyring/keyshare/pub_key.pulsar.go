...
var file_fairyring_keyshare_pub_key_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_fairyring_keyshare_pub_key_proto_goTypes = []interface{}{
	(*ActivePubKey)(nil), // 0: fairyring.keyshare.ActivePubKey
	(*QueuedPubKey)(nil), // 1: fairyring.keyshare.QueuedPubKey
}
