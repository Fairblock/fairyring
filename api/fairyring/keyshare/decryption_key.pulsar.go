...
func init() {
	...
	md_DecryptionKey = File_fairyring_keyshare_decryption_key_proto.Messages().ByName("DecryptionKey")
...
func (x *DecryptionKey) slowProtoReflect() protoreflect.Message {
	mi := &file_fairyring_keyshare_decryption_key_proto_msgTypes[0]
...
func (x *fastReflection_DecryptionKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "fairyring.keyshare.DecryptionKey.height":
		return x.Height != uint64(0)
	case "fairyring.keyshare.DecryptionKey.data":
		return x.Data != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.keyshare.DecryptionKey"))
		}
		panic(fmt.Errorf("message fairyring.keyshare.DecryptionKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_DecryptionKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message fairyring.keyshare.DecryptionKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_DecryptionKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "fairyring.keyshare.DecryptionKey.height":
		panic(fmt.Errorf("field height of message fairyring.keyshare.DecryptionKey is not mutable"))
	case "fairyring.keyshare.DecryptionKey.data":
		panic(fmt.Errorf("field data of message fairyring.keyshare.DecryptionKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.keyshare.DecryptionKey"))
		}
...
func (x *fastReflection_DecryptionKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in fairyring.keyshare.DecryptionKey", d.FullName()))
	}
	panic("unreachable")
}
...
func (*DecryptionKey) Descriptor() ([]byte, []int) {
	return file_fairyring_keyshare_decryption_key_proto_rawDescGZIP(), []int{0}
}
...
var file_fairyring_keyshare_decryption_key_proto_rawDesc = []byte{
	0x0a, 0x27, 0x66, 0x61, 0x69, 0x72, 0x79, 0x72, 0x69, 0x6e, 0x67, 0x2f, 0x6b, 0x65, 0x79, 0x73,
	0x68, 0x61, 0x72, 0x65, 0x2f, 0x64, 0x65, 0x63, 0x72, 0x79, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x5f,
	0x6b, 0x65, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x12, 0x66, 0x61, 0x69, 0x72, 0x79,
	0x72, 0x69, 0x6e, 0x67, 0x2e, 0x6b, 0x65, 0x79, 0x73, 0x68, 0x61, 0x72, 0x65, 0x22, 0x3b, 0x0a,
	0x0d, 0x44, 0x65, 0x63, 0x72, 0x79, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x4b, 0x65, 0x79, 0x12, 0x16,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0xba, 0x01, 0x0a, 0x16, 0x63,
	0x6f, 0x6d, 0x2e, 0x66, 0x61, 0x69, 0x72, 0x79, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x6b, 0x65, 0x79,
	0x73, 0x68, 0x61, 0x72, 0x65, 0x42, 0x12, 0x44, 0x65, 0x63, 0x72, 0x79, 0x70, 0x74, 0x69, 0x6f,
	0x6e, 0x4b, 0x65, 0x79, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x23, 0x63, 0x6f, 0x73,
...
var (
	file_fairyring_keyshare_decryption_key_proto_rawDescOnce sync.Once
	file_fairyring_keyshare_decryption_key_proto_rawDescData = file_fairyring_keyshare_decryption_key_proto_rawDesc
)

func file_fairyring_keyshare_decryption_key_proto_rawDescGZIP() []byte {
	file_fairyring_keyshare_decryption_key_proto_rawDescOnce.Do(func() {
		file_fairyring_keyshare_decryption_key_proto_rawDescData = protoimpl.X.CompressGZIP(file_fairyring_keyshare_decryption_key_proto_rawDescData)
	})
	return file_fairyring_keyshare_decryption_key_proto_rawDescData
}

var file_fairyring_keyshare_decryption_key_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_fairyring_keyshare_decryption_key_proto_goTypes = []interface{}{
	(*DecryptionKey)(nil), // 0: fairyring.keyshare.DecryptionKey
}
var file_fairyring_keyshare_decryption_key_proto_depIdxs = []int32{
...
func init() { file_fairyring_keyshare_decryption_key_proto_init() }
func file_fairyring_keyshare_decryption_key_proto_init() {
	if File_fairyring_keyshare_decryption_key_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_fairyring_keyshare_decryption_key_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_fairyring_keyshare_decryption_key_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		...
		DependencyIndexes: file_fairyring_keyshare_decryption_key_proto_depIdxs,
		MessageInfos:      file_fairyring_keyshare_decryption_key_proto_msgTypes,
	}.Build()
	File_fairyring_keyshare_decryption_key_proto = out.File
	file_fairyring_keyshare_decryption_key_proto_rawDesc = nil
	file_fairyring_keyshare_decryption_key_proto_goTypes = nil
	file_fairyring_keyshare_decryption_key_proto_depIdxs = nil
}
