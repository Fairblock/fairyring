...
var (
	...
	fd_ValidatorSet_cons_addr protoreflect.FieldDescriptor
	fd_ValidatorSet_is_active protoreflect.FieldDescriptor
)
...
func init() {
	...
	fd_ValidatorSet_cons_addr = md_ValidatorSet.Fields().ByName("cons_addr")
	fd_ValidatorSet_is_active = md_ValidatorSet.Fields().ByName("is_active")
}
...
func (x *fastReflection_ValidatorSet) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.ConsAddr != "" {
		...
		if !f(fd_ValidatorSet_cons_addr, value) {
			return
		}
	}
	if x.IsActive != false {
		value := protoreflect.ValueOfBool(x.IsActive)
		if !f(fd_ValidatorSet_is_active, value) {
			return
		}
	}
}
...
func (x *fastReflection_ValidatorSet) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "fairyring.keyshare.ValidatorSet.validator":
		return x.Validator != ""
	case "fairyring.keyshare.ValidatorSet.cons_addr":
		return x.ConsAddr != ""
	case "fairyring.keyshare.ValidatorSet.is_active":
...
func (x *fastReflection_ValidatorSet) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "fairyring.keyshare.ValidatorSet.cons_addr":
		panic(fmt.Errorf("field cons_addr of message fairyring.keyshare.ValidatorSet is not mutable"))
	case "fairyring.keyshare.ValidatorSet.is_active":
		panic(fmt.Errorf("field is_active of message fairyring.keyshare.ValidatorSet is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.keyshare.ValidatorSet"))
		}
...
var file_fairyring_keyshare_validator_set_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x67, 0x2e, 0x6b, 0x65, 0x79, 0x73, 0x68, 0x61, 0x72, 0x65, 0x22, 0x7c, 0x0a, 0x0c,
	...
	0x12, 0x1b, 0x0a, 0x09, 0x63, 0x6f, 0x6e, 0x73, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x08, 0x63, 0x6f, 0x6e, 0x73, 0x41, 0x64, 0x64, 0x72, 0x12, 0x1b, 0x0a,
	0x09, 0x69, 0x73, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x08, 0x69, 0x73, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x42, 0xb9, 0x01, 0x0a, 0x16, 0x63,
	0x6f, 0x6d, 0x2e, 0x66, 0x61, 0x69, 0x72, 0x79, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x6b, 0x65, 0x79,
	0x73, 0x68, 0x61, 0x72, 0x65, 0x42, 0x11, 0x56, 0x61, 0x6c, 0x69, 0x64, 0x61, 0x74, 0x6f, 0x72,
	0x53, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x23, 0x63, 0x6f, 0x73, 0x6d,
