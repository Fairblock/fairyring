...
func init() {
	...
	md_ActivePubKey = File_fairyring_pep_pub_key_proto.Messages().ByName("ActivePubKey")
...
func (x *ActivePubKey) slowProtoReflect() protoreflect.Message {
	mi := &file_fairyring_pep_pub_key_proto_msgTypes[0]
...
func (x *fastReflection_ActivePubKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "fairyring.pep.ActivePubKey.publicKey":
		return x.PublicKey != ""
	case "fairyring.pep.ActivePubKey.creator":
		return x.Creator != ""
	case "fairyring.pep.ActivePubKey.expiry":
		return x.Expiry != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.pep.ActivePubKey"))
		}
		panic(fmt.Errorf("message fairyring.pep.ActivePubKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_ActivePubKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message fairyring.pep.ActivePubKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_ActivePubKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "fairyring.pep.ActivePubKey.publicKey":
		panic(fmt.Errorf("field publicKey of message fairyring.pep.ActivePubKey is not mutable"))
	case "fairyring.pep.ActivePubKey.creator":
		panic(fmt.Errorf("field creator of message fairyring.pep.ActivePubKey is not mutable"))
	case "fairyring.pep.ActivePubKey.expiry":
		panic(fmt.Errorf("field expiry of message fairyring.pep.ActivePubKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.pep.ActivePubKey"))
		}
...
func (x *fastReflection_ActivePubKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in fairyring.pep.ActivePubKey", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_fairyring_pep_pub_key_proto_init()
	md_QueuedPubKey = File_fairyring_pep_pub_key_proto.Messages().ByName("QueuedPubKey")
...
func (x *QueuedPubKey) slowProtoReflect() protoreflect.Message {
	mi := &file_fairyring_pep_pub_key_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueuedPubKey) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "fairyring.pep.QueuedPubKey.publicKey":
		return x.PublicKey != ""
	case "fairyring.pep.QueuedPubKey.creator":
		return x.Creator != ""
	case "fairyring.pep.QueuedPubKey.expiry":
		return x.Expiry != uint64(0)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.pep.QueuedPubKey"))
		}
		panic(fmt.Errorf("message fairyring.pep.QueuedPubKey does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueuedPubKey) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message fairyring.pep.QueuedPubKey does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueuedPubKey) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "fairyring.pep.QueuedPubKey.publicKey":
		panic(fmt.Errorf("field publicKey of message fairyring.pep.QueuedPubKey is not mutable"))
	case "fairyring.pep.QueuedPubKey.creator":
		panic(fmt.Errorf("field creator of message fairyring.pep.QueuedPubKey is not mutable"))
	case "fairyring.pep.QueuedPubKey.expiry":
		panic(fmt.Errorf("field expiry of message fairyring.pep.QueuedPubKey is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.pep.QueuedPubKey"))
		}
...
func (x *fastReflection_QueuedPubKey) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in fairyring.pep.QueuedPubKey", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: fairyring/pep/pub_key.proto
...
func (*ActivePubKey) Descriptor() ([]byte, []int) {
	return file_fairyring_pep_pub_key_proto_rawDescGZIP(), []int{0}
}
...
func (*QueuedPubKey) Descriptor() ([]byte, []int) {
	return file_fairyring_pep_pub_key_proto_rawDescGZIP(), []int{1}
}
...
var file_fairyring_pep_pub_key_proto_rawDesc = []byte{
	0x0a, 0x1b, 0x66, 0x61, 0x69, 0x72, 0x79, 0x72, 0x69, 0x6e, 0x67, 0x2f, 0x70, 0x65, 0x70, 0x2f,
	0x70, 0x75, 0x62, 0x5f, 0x6b, 0x65, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x66,
	0x61, 0x69, 0x72, 0x79, 0x72, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x65, 0x70, 0x22, 0x5e, 0x0a, 0x0c,
	0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x50, 0x75, 0x62, 0x4b, 0x65, 0x79, 0x12, 0x1c, 0x0a, 0x09,
	...
	,
...
var (
	file_fairyring_pep_pub_key_proto_rawDescOnce sync.Once
	file_fairyring_pep_pub_key_proto_rawDescData = file_fairyring_pep_pub_key_proto_rawDesc
)

func file_fairyring_pep_pub_key_proto_rawDescGZIP() []byte {
	file_fairyring_pep_pub_key_proto_rawDescOnce.Do(func() {
		file_fairyring_pep_pub_key_proto_rawDescData = protoimpl.X.CompressGZIP(file_fairyring_pep_pub_key_proto_rawDescData)
	})
	return file_fairyring_pep_pub_key_proto_rawDescData
}

var file_fairyring_pep_pub_key_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_fairyring_pep_pub_key_proto_goTypes = []interface{}{
	(*ActivePubKey)(nil), // 0: fairyring.pep.ActivePubKey
	(*QueuedPubKey)(nil), // 1: fairyring.pep.QueuedPubKey
}
var file_fairyring_pep_pub_key_proto_depIdxs = []int32{
...
func init() { file_fairyring_pep_pub_key_proto_init() }
func file_fairyring_pep_pub_key_proto_init() {
	if File_fairyring_pep_pub_key_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_fairyring_pep_pub_key_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_fairyring_pep_pub_key_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_fairyring_pep_pub_key_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_fairyring_pep_pub_key_proto_goTypes,
		DependencyIndexes: file_fairyring_pep_pub_key_proto_depIdxs,
		MessageInfos:      file_fairyring_pep_pub_key_proto_msgTypes,
	}.Build()
	File_fairyring_pep_pub_key_proto = out.File
	file_fairyring_pep_pub_key_proto_rawDesc = nil
	file_fairyring_pep_pub_key_proto_goTypes = nil
	file_fairyring_pep_pub_key_proto_depIdxs = nil
}
