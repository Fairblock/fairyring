...
var (
	...
	fd_PrivateRequest_created_via_contract    protoreflect.FieldDescriptor
...
func init() {
	...
	fd_PrivateRequest_created_via_contract = md_PrivateRequest.Fields().ByName("created_via_contract")
...
func (x *fastReflection_PrivateRequest) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	...
	if x.CreatedViaContract != false {
		...
		if !f(fd_PrivateRequest_created_via_contract, value) {
			return
		}
	}
	if len(x.PrivateDecryptionKeys) != 0 {
		value := protoreflect.ValueOfList(&_PrivateRequest_5_list{list: &x.PrivateDecryptionKeys})
...
func (x *fastReflection_PrivateRequest) Has(fd protoreflect.FieldDescriptor) bool {
	...
	case "fairyring.pep.PrivateRequest.pubkey":
		return x.Pubkey != ""
	case "fairyring.pep.PrivateRequest.created_via_contract":
...
func (x *fastReflection_PrivateRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "fairyring.pep.PrivateRequest.private_decryption_keys":
		...
		listValue := &_PrivateRequest_5_list{list: &x.PrivateDecryptionKeys}
...
func (x *fastReflection_PrivateRequest) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "fairyring.pep.PrivateRequest.private_decryption_keys":
		...
		value := &_PrivateRequest_5_list{list: &x.PrivateDecryptionKeys}
	...
	case "fairyring.pep.PrivateRequest.created_via_contract":
		panic(fmt.Errorf("field created_via_contract of message fairyring.pep.PrivateRequest is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.pep.PrivateRequest"))
		}
...
var (
	md_ExecuteContractPrivateMsg                        protoreflect.MessageDescriptor
	fd_ExecuteContractPrivateMsg_identity               protoreflect.FieldDescriptor
	fd_ExecuteContractPrivateMsg_private_decryption_key protoreflect.FieldDescriptor
)

func init() {
	file_fairyring_pep_request_id_proto_init()
	md_ExecuteContractPrivateMsg = File_fairyring_pep_request_id_proto.Messages().ByName("ExecuteContractPrivateMsg")
	fd_ExecuteContractPrivateMsg_identity = md_ExecuteContractPrivateMsg.Fields().ByName("identity")
	fd_ExecuteContractPrivateMsg_private_decryption_key = md_ExecuteContractPrivateMsg.Fields().ByName("private_decryption_key")
}

var _ protoreflect.Message = (*fastReflection_ExecuteContractPrivateMsg)(nil)

type fastReflection_ExecuteContractPrivateMsg ExecuteContractPrivateMsg

func (x *ExecuteContractPrivateMsg) ProtoReflect() protoreflect.Message {
	return (*fastReflection_ExecuteContractPrivateMsg)(x)
}

func (x *ExecuteContractPrivateMsg) slowProtoReflect() protoreflect.Message {
	mi := &file_fairyring_pep_request_id_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_ExecuteContractPrivateMsg_messageType fastReflection_ExecuteContractPrivateMsg_messageType
var _ protoreflect.MessageType = fastReflection_ExecuteContractPrivateMsg_messageType{}

type fastReflection_ExecuteContractPrivateMsg_messageType struct{}

func (x fastReflection_ExecuteContractPrivateMsg_messageType) Zero() protoreflect.Message {
	return (*fastReflection_ExecuteContractPrivateMsg)(nil)
}
func (x fastReflection_ExecuteContractPrivateMsg_messageType) New() protoreflect.Message {
	return new(fastReflection_ExecuteContractPrivateMsg)
}
func (x fastReflection_ExecuteContractPrivateMsg_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_ExecuteContractPrivateMsg
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_ExecuteContractPrivateMsg) Descriptor() protoreflect.MessageDescriptor {
	return md_ExecuteContractPrivateMsg
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_ExecuteContractPrivateMsg) Type() protoreflect.MessageType {
	return _fastReflection_ExecuteContractPrivateMsg_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_ExecuteContractPrivateMsg) New() protoreflect.Message {
	return new(fastReflection_ExecuteContractPrivateMsg)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_ExecuteContractPrivateMsg) Interface() protoreflect.ProtoMessage {
	return (*ExecuteContractPrivateMsg)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_ExecuteContractPrivateMsg) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.Identity != "" {
		value := protoreflect.ValueOfString(x.Identity)
		if !f(fd_ExecuteContractPrivateMsg_identity, value) {
			return
		}
	}
	if x.PrivateDecryptionKey != nil {
		value := protoreflect.ValueOfMessage(x.PrivateDecryptionKey.ProtoReflect())
		if !f(fd_ExecuteContractPrivateMsg_private_decryption_key, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_ExecuteContractPrivateMsg) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "fairyring.pep.ExecuteContractPrivateMsg.identity":
		return x.Identity != ""
	case "fairyring.pep.ExecuteContractPrivateMsg.private_decryption_key":
		return x.PrivateDecryptionKey != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.pep.ExecuteContractPrivateMsg"))
		}
		panic(fmt.Errorf("message fairyring.pep.ExecuteContractPrivateMsg does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ExecuteContractPrivateMsg) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "fairyring.pep.ExecuteContractPrivateMsg.identity":
		x.Identity = ""
	case "fairyring.pep.ExecuteContractPrivateMsg.private_decryption_key":
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_ExecuteContractPrivateMsg) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "fairyring.pep.ExecuteContractPrivateMsg.identity":
		value := x.Identity
		return protoreflect.ValueOfString(value)
	case "fairyring.pep.ExecuteContractPrivateMsg.private_decryption_key":
		value := x.PrivateDecryptionKey
		return protoreflect.ValueOfMessage(value.ProtoReflect())
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.pep.ExecuteContractPrivateMsg"))
		}
		panic(fmt.Errorf("message fairyring.pep.ExecuteContractPrivateMsg does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ExecuteContractPrivateMsg) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "fairyring.pep.ExecuteContractPrivateMsg.identity":
		x.Identity = value.Interface().(string)
	case "fairyring.pep.ExecuteContractPrivateMsg.private_decryption_key":
		x.PrivateDecryptionKey = value.Message().Interface().(*common.PrivateDecryptionKey)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.pep.ExecuteContractPrivateMsg"))
		}
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ExecuteContractPrivateMsg) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "fairyring.pep.ExecuteContractPrivateMsg.private_decryption_key":
		if x.PrivateDecryptionKey == nil {
			x.PrivateDecryptionKey = new(common.PrivateDecryptionKey)
		}
		return protoreflect.ValueOfMessage(x.PrivateDecryptionKey.ProtoReflect())
	case "fairyring.pep.ExecuteContractPrivateMsg.identity":
		panic(fmt.Errorf("field identity of message fairyring.pep.ExecuteContractPrivateMsg is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: fairyring.pep.ExecuteContractPrivateMsg"))
		}
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_ExecuteContractPrivateMsg) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "fairyring.pep.ExecuteContractPrivateMsg.identity":
		return protoreflect.ValueOfString("")
	case "fairyring.pep.ExecuteContractPrivateMsg.private_decryption_key":
		m := new(common.PrivateDecryptionKey)
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_ExecuteContractPrivateMsg) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in fairyring.pep.ExecuteContractPrivateMsg", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_ExecuteContractPrivateMsg) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_ExecuteContractPrivateMsg) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_ExecuteContractPrivateMsg) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_ExecuteContractPrivateMsg) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*ExecuteContractPrivateMsg)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
		...
		if x.PrivateDecryptionKey != nil {
			l = options.Size(x.PrivateDecryptionKey)
			n += 1 + l + runtime.Sov(uint64(l))
		}
		if x.unknownFields != nil {
			n += len(x.unknownFields)
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.PrivateDecryptionKey != nil {
			encoded, err := options.Marshal(x.PrivateDecryptionKey)
			if err != nil {
				return protoiface.MarshalOutput{
					NoUnkeyedLiterals: input.NoUnkeyedLiterals,
					Buf:               input.Buf,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ExecuteContractPrivateMsg: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: ExecuteContractPrivateMsg: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType != 2 {
			...
			case 2:
				...
				if err := options.Unmarshal(dAtA[iNdEx:postIndex], x.PrivateDecryptionKey); err != nil {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, err
				}
				iNdEx = postIndex
			default:
...
func (x *PrivateRequest) GetCreatedViaContract() bool {
	if x != nil {
...
type ExecuteContractPrivateMsg struct {
	...
	Identity             string                       `protobuf:"bytes,1,opt,name=identity,proto3" json:"identity,omitempty"`
	PrivateDecryptionKey *common.PrivateDecryptionKey `protobuf:"bytes,2,opt,name=private_decryption_key,json=privateDecryptionKey,proto3" json:"private_decryption_key,omitempty"`
}

func (x *ExecuteContractPrivateMsg) Reset() {
	*x = ExecuteContractPrivateMsg{}
	if protoimpl.UnsafeEnabled {
		mi := &file_fairyring_pep_request_id_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
...
func (x *ExecuteContractPrivateMsg) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ExecuteContractPrivateMsg) ProtoMessage() {}

// Deprecated: Use ExecuteContractPrivateMsg.ProtoReflect.Descriptor instead.
func (*ExecuteContractPrivateMsg) Descriptor() ([]byte, []int) {
	return file_fairyring_pep_request_id_proto_rawDescGZIP(), []int{5}
}

func (x *ExecuteContractPrivateMsg) GetIdentity() string {
	if x != nil {
		return x.Identity
	}
	return ""
...
func (x *ExecuteContractPrivateMsg) GetPrivateDecryptionKey() *common.PrivateDecryptionKey {
	if x != nil {
...
var file_fairyring_pep_request_id_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x05, 0x72, 0x65, 0x71, 0x49, 0x64, 0x22, 0xf0, 0x01, 0x0a, 0x0e, 0x50, 0x72, 0x69,
	...
	0x09, 0x52, 0x06, 0x70, 0x75, 0x62, 0x6b, 0x65, 0x79, 0x12, 0x30, 0x0a, 0x14, 0x63, 0x72, 0x65,
	0x61, 0x74, 0x65, 0x64, 0x5f, 0x76, 0x69, 0x61, 0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63,
	0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x12, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64,
	0x56, 0x69, 0x61, 0x43, 0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x12, 0x5e, 0x0a, 0x17, 0x70,
	0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x5f, 0x64, 0x65, 0x63, 0x72, 0x79, 0x70, 0x74, 0x69, 0x6f,
	0x6e, 0x5f, 0x6b, 0x65, 0x79, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x26, 0x2e, 0x66,
	...
	0x72, 0x79, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x4b, 0x65, 0x79, 0x73, 0x22, 0x5a, 0x0a, 0x0f, 0x43,
	0x6f, 0x6e, 0x74, 0x72, 0x61, 0x63, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x1c,
	0x0a, 0x09, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x09, 0x72, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x61, 0x72, 0x12, 0x29, 0x0a, 0x10,
	...
	,
	...
	,
...
var file_fairyring_pep_request_id_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_fairyring_pep_request_id_proto_goTypes = []interface{}{
	...
	(*ExecuteContractPrivateMsg)(nil),   // 5: fairyring.pep.ExecuteContractPrivateMsg
	(*common.PrivateDecryptionKey)(nil), // 6: fairyring.common.PrivateDecryptionKey
}
var file_fairyring_pep_request_id_proto_depIdxs = []int32{
	6, // 0: fairyring.pep.PrivateRequest.private_decryption_keys:type_name -> fairyring.common.PrivateDecryptionKey
	2, // 1: fairyring.pep.RegisteredContract.contracts:type_name -> fairyring.pep.ContractDetails
	6, // 2: fairyring.pep.ExecuteContractPrivateMsg.private_decryption_key:type_name -> fairyring.common.PrivateDecryptionKey
...
func file_fairyring_pep_request_id_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_fairyring_pep_request_id_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ExecuteContractPrivateMsg); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
