...
jq '.app_state.keyshare.params.trusted_addresses = ["fairy1p6ca57cu5u89qzf58krxgxaezp4wm9vu7lur3c"]' $GENESIS_FILE_PATH > temp.json

jq '.app_state.keyshare.validatorSetList = [{"validator":"fairy1p6ca57cu5u89qzf58krxgxaezp4wm9vu7lur3c", "index": "fairy1p6ca57cu5u89qzf58krxgxaezp4wm9vu7lur3c", "isActive":true}]' temp.json > updated_genesis.json
...
./fairyringd start --rpc.laddr tcp://127.0.0.1:26657 --grpc.address localhost:9092 --grpc-web.address localhost:9093 --api.address tcp://localhost:1318
