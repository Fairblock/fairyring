...
export const Keyshare: MessageFns<Keyshare> = {
  encode(message: Keyshare, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Keyshare {
...
export const GeneralKeyshare: MessageFns<GeneralKeyshare> = {
  encode(message: GeneralKeyshare, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.validator !== "") {
      writer.uint32(10).string(message.validator);
    }
    if (message.idType !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GeneralKeyshare {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ValidatorEncryptedKeyshare: MessageFns<ValidatorEncryptedKeyshare> = {
  encode(message: ValidatorEncryptedKeyshare, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.validator !== "") {
      writer.uint32(10).string(message.validator);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ValidatorEncryptedKeyshare {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
