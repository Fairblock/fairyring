...
export const Proposal: MessageFns<Proposal> = {
  encode(message: Proposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.hasEncryptedVotes !== false) {
  ...
  fromJSON(object: any): Proposal {
    return {
      ...
      hasEncryptedVotes: isSet(object.hasEncryptedVotes) ? globalThis.Boolean(object.hasEncryptedVotes) : false,
...
export const TallyResult: MessageFns<TallyResult> = {
  ...
  fromJSON(object: any): TallyResult {
    return {
      ...
      encryptedCount: isSet(object.encryptedCount) ? globalThis.String(object.encryptedCount) : "",
    };
  },
  ...
  fromJSON(object: any): Vote {
    return {
      ...
      options: globalThis.Array.isArray(object?.options)
        ...
        : [],
      metadata: isSet(object.metadata) ? globalThis.String(object.metadata) : "",
      encryptedVoteData: isSet(object.encryptedVoteData) ? globalThis.String(object.encryptedVoteData) : "",
    };
  },
...
export const Params: MessageFns<Params> = {
  encode(message: Params, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.maxTallyPeriod !== undefined) {
      Duration.encode(message.maxTallyPeriod, writer.uint32(138).fork()).join();
    }
    for (const v of message.trustedCounterParties) {
      TrustedCounterParty.encode(v!, writer.uint32(146).fork()).join();
    }
...
export const DecryptedVoteOption: MessageFns<DecryptedVoteOption> = {
  encode(message: DecryptedVoteOption, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.option !== 0) {
      writer.uint32(8).int32(message.option);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DecryptedVoteOption {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.randomNo = longToNumber(reader.int64());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): DecryptedVoteOption {
    return {
      option: isSet(object.option) ? voteOptionFromJSON(object.option) : 0,
      randomNo: isSet(object.randomNo) ? globalThis.Number(object.randomNo) : 0,
    };
  },
