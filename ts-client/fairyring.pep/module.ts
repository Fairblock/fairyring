...
export { GenesisState, QueryParamsResponse, QueryShowPrivateKeyshareReqRequest, MsgCreateAggregatedKeyShareResponse, GenEncTxExecutionQueue, QueryGetPepNonceRequest, QueryKeyshareRequest, MsgUpdateParamsResponse, MsgRequestPrivateIdentityResponse, QueryParamsRequest, AggregatedKeyShare, TrustedCounterParty, EncryptedTx, QueryShowPrivateKeyshareReqResponse, MsgRequestPrivateIdentity, GeneralEncryptedTxArray, RequestId, QueryAllEncryptedTxFromHeightResponse, GeneralEncryptedTx, PepNonce, QueryPubKeyRequest, MsgSubmitEncryptedTxResponse, QueryAllKeyshareResponse, QueryGetPepNonceResponse, MsgSubmitGeneralEncryptedTx, MsgGetPrivateKeyshares, EncryptedTxArray, QueryGetEncryptedTxRequest, QueryAllPepNonceRequest, QueryLatestHeightRequest, MsgCreateAggregatedKeyShare, Params, MsgGetGeneralKeyshare, QueryAllEncryptedTxFromHeightRequest, MsgRequestGeneralKeyshare, MsgRequestGeneralKeyshareResponse, QueryAllKeyshareRequest, QueryKeyshareResponse, QueryAllPepNonceResponse, QueryPubKeyResponse, MsgUpdateParams, MsgGetGeneralKeyshareResponse, MsgGetPrivateKeysharesResponse, PrivateRequest, MsgSubmitEncryptedTx, QueryGetEncryptedTxResponse, QueryAllEncryptedTxRequest, QueryAllEncryptedTxResponse, QueryLatestHeightResponse };
...
type sendQueryShowPrivateKeyshareReqRequestParams = {
  value: QueryShowPrivateKeyshareReqRequest,
  fee?: StdFee,
  memo?: string
};
...
type sendQueryShowPrivateKeyshareReqResponseParams = {
  value: QueryShowPrivateKeyshareReqResponse,
  fee?: StdFee,
  memo?: string
};
...
type sendMsgGetPrivateKeysharesParams = {
  value: MsgGetPrivateKeyshares,
  fee?: StdFee,
  memo?: string
};
...
type sendMsgGetPrivateKeysharesResponseParams = {
  value: MsgGetPrivateKeysharesResponse,
  fee?: StdFee,
  memo?: string
};
...
type queryShowPrivateKeyshareReqRequestParams = {
  value: QueryShowPrivateKeyshareReqRequest,
};
...
type queryShowPrivateKeyshareReqResponseParams = {
  value: QueryShowPrivateKeyshareReqResponse,
};
...
type msgGetPrivateKeysharesParams = {
  value: MsgGetPrivateKeyshares,
};
...
type msgGetPrivateKeysharesResponseParams = {
  value: MsgGetPrivateKeysharesResponse,
};
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		async sendQueryShowPrivateKeyshareReqRequest({ value, fee, memo }: sendQueryShowPrivateKeyshareReqRequestParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryShowPrivateKeyshareReqRequest: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryShowPrivateKeyshareReqRequest({ value: QueryShowPrivateKeyshareReqRequest.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryShowPrivateKeyshareReqRequest: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendQueryShowPrivateKeyshareReqResponse({ value, fee, memo }: sendQueryShowPrivateKeyshareReqResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendQueryShowPrivateKeyshareReqResponse: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.queryShowPrivateKeyshareReqResponse({ value: QueryShowPrivateKeyshareReqResponse.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendQueryShowPrivateKeyshareReqResponse: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendMsgGetPrivateKeyshares({ value, fee, memo }: sendMsgGetPrivateKeysharesParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendMsgGetPrivateKeyshares: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.msgGetPrivateKeyshares({ value: MsgGetPrivateKeyshares.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendMsgGetPrivateKeyshares: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendMsgGetPrivateKeysharesResponse({ value, fee, memo }: sendMsgGetPrivateKeysharesResponseParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendMsgGetPrivateKeysharesResponse: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.msgGetPrivateKeysharesResponse({ value: MsgGetPrivateKeysharesResponse.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendMsgGetPrivateKeysharesResponse: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		queryShowPrivateKeyshareReqRequest({ value }: queryShowPrivateKeyshareReqRequestParams): EncodeObject {
			try {
				return { typeUrl: "/fairyring.pep.QueryShowPrivateKeyshareReqRequest", value: QueryShowPrivateKeyshareReqRequest.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryShowPrivateKeyshareReqRequest: Could not create message: ' + e.message)
			}
		},
		...
		queryShowPrivateKeyshareReqResponse({ value }: queryShowPrivateKeyshareReqResponseParams): EncodeObject {
			try {
				return { typeUrl: "/fairyring.pep.QueryShowPrivateKeyshareReqResponse", value: QueryShowPrivateKeyshareReqResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:QueryShowPrivateKeyshareReqResponse: Could not create message: ' + e.message)
			}
		},
		...
		msgGetPrivateKeyshares({ value }: msgGetPrivateKeysharesParams): EncodeObject {
			try {
				return { typeUrl: "/fairyring.pep.MsgGetPrivateKeyshares", value: MsgGetPrivateKeyshares.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgGetPrivateKeyshares: Could not create message: ' + e.message)
			}
		},
		...
		msgGetPrivateKeysharesResponse({ value }: msgGetPrivateKeysharesResponseParams): EncodeObject {
			try {
				return { typeUrl: "/fairyring.pep.MsgGetPrivateKeysharesResponse", value: MsgGetPrivateKeysharesResponse.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:MsgGetPrivateKeysharesResponse: Could not create message: ' + e.message)
			}
		},
