...
export const KeysharePacketData: MessageFns<KeysharePacketData> = {
  encode(message: KeysharePacketData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.noData !== undefined) {
      NoData.encode(message.noData, writer.uint32(10).fork()).join();
    }
    if (message.requestDecryptionKeyPacket !== undefined) {
      RequestDecryptionKeyPacketData.encode(message.requestDecryptionKeyPacket, writer.uint32(18).fork()).join();
    }
    if (message.getDecryptionKeyPacket !== undefined) {
      GetDecryptionKeyPacketData.encode(message.getDecryptionKeyPacket, writer.uint32(26).fork()).join();
    }
    if (message.decryptionKeyDataPacket !== undefined) {
      DecryptionKeyDataPacketData.encode(message.decryptionKeyDataPacket, writer.uint32(34).fork()).join();
    }
    ...
    if (message.currentKeysPacket !== undefined) {
      CurrentKeysPacketData.encode(message.currentKeysPacket, writer.uint32(50).fork()).join();
    }
    ...
    if (message.getPrivateDecryptionKeyPacket !== undefined) {
      GetPrivateDecryptionKeyPacketData.encode(message.getPrivateDecryptionKeyPacket, writer.uint32(66).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): KeysharePacketData {
...
export const RequestDecryptionKeyPacketData: MessageFns<RequestDecryptionKeyPacketData> = {
  encode(message: RequestDecryptionKeyPacketData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RequestDecryptionKeyPacketData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseRequestPrivateDecryptionKeyPacketData(): RequestPrivateDecryptionKeyPacketData {
  return { requester: "", requestId: "" };
}

export const RequestPrivateDecryptionKeyPacketData: MessageFns<RequestPrivateDecryptionKeyPacketData> = {
  encode(message: RequestPrivateDecryptionKeyPacketData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.requester !== "") {
      writer.uint32(10).string(message.requester);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RequestPrivateDecryptionKeyPacketData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RequestPrivateDecryptionKeyPacketAck: MessageFns<RequestPrivateDecryptionKeyPacketAck> = {
  encode(message: RequestPrivateDecryptionKeyPacketAck, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identity !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RequestPrivateDecryptionKeyPacketAck {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RequestDecryptionKeyPacketAck: MessageFns<RequestDecryptionKeyPacketAck> = {
  encode(message: RequestDecryptionKeyPacketAck, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identity !== "") {
      writer.uint32(10).string(message.identity);
    }
    if (message.pubkey !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RequestDecryptionKeyPacketAck {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetDecryptionKeyPacketData: MessageFns<GetDecryptionKeyPacketData> = {
  encode(message: GetDecryptionKeyPacketData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identity !== "") {
      writer.uint32(10).string(message.identity);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetDecryptionKeyPacketData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetDecryptionKeyPacketAck: MessageFns<GetDecryptionKeyPacketAck> = {
  encode(_: GetDecryptionKeyPacketAck, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetDecryptionKeyPacketAck {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetPrivateDecryptionKeyPacketData: MessageFns<GetPrivateDecryptionKeyPacketData> = {
  encode(message: GetPrivateDecryptionKeyPacketData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identity !== "") {
      writer.uint32(10).string(message.identity);
    }
    if (message.requester !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetPrivateDecryptionKeyPacketData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const GetPrivateDecryptionKeyPacketAck: MessageFns<GetPrivateDecryptionKeyPacketAck> = {
  encode(_: GetPrivateDecryptionKeyPacketAck, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetPrivateDecryptionKeyPacketAck {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseDecryptionKeyDataPacketData(): DecryptionKeyDataPacketData {
  return { identity: "", pubkey: "", decryptionKey: "", aggrHeight: "", proposalId: "", requestId: "", retries: 0 };
}

export const DecryptionKeyDataPacketData: MessageFns<DecryptionKeyDataPacketData> = {
  encode(message: DecryptionKeyDataPacketData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identity !== "") {
      writer.uint32(10).string(message.identity);
    }
    if (message.pubkey !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DecryptionKeyDataPacketData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 7:
          ...
          message.retries = longToNumber(reader.uint64());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): DecryptionKeyDataPacketData {
    return {
      ...
      aggrHeight: isSet(object.aggrHeight) ? globalThis.String(object.aggrHeight) : "",
...
export const DecryptionKeyPacketAck: MessageFns<DecryptionKeyPacketAck> = {
  encode(_: DecryptionKeyPacketAck, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DecryptionKeyPacketAck {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBasePrivateDecryptionKeyDataPacketData(): PrivateDecryptionKeyDataPacketData {
  return { identity: "", pubkey: "", requestId: "", privateDecryptionKey: [] };
}

export const PrivateDecryptionKeyDataPacketData: MessageFns<PrivateDecryptionKeyDataPacketData> = {
  encode(message: PrivateDecryptionKeyDataPacketData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.identity !== "") {
      writer.uint32(10).string(message.identity);
    }
    if (message.pubkey !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PrivateDecryptionKeyDataPacketData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): PrivateDecryptionKeyDataPacketData {
    return {
      ...
      pubkey: isSet(object.pubkey) ? globalThis.String(object.pubkey) : "",
      requestId: isSet(object.requestId) ? globalThis.String(object.requestId) : "",
      privateDecryptionKey: globalThis.Array.isArray(object?.privateDecryptionKey)
...
export const PrivateDecryptionKeyPacketAck: MessageFns<PrivateDecryptionKeyPacketAck> = {
  encode(_: PrivateDecryptionKeyPacketAck, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): PrivateDecryptionKeyPacketAck {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CurrentKeysPacketData: MessageFns<CurrentKeysPacketData> = {
  encode(_: CurrentKeysPacketData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CurrentKeysPacketData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CurrentKeysPacketAck: MessageFns<CurrentKeysPacketAck> = {
  encode(message: CurrentKeysPacketAck, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.activeKey !== undefined) {
      ActivePublicKey.encode(message.activeKey, writer.uint32(10).fork()).join();
    }
    if (message.queuedKey !== undefined) {
      QueuedPublicKey.encode(message.queuedKey, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CurrentKeysPacketAck {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
