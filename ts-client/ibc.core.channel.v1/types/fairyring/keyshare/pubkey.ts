...
export const EncryptedKeyshare: MessageFns<EncryptedKeyshare> = {
  encode(message: EncryptedKeyshare, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.data !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EncryptedKeyshare {
...
export const ActivePubkey: MessageFns<ActivePubkey> = {
  encode(message: ActivePubkey, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ActivePubkey {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const QueuedPubkey: MessageFns<QueuedPubkey> = {
  encode(message: QueuedPubkey, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.publicKey !== "") {
      writer.uint32(10).string(message.publicKey);
    }
    if (message.creator !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueuedPubkey {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
