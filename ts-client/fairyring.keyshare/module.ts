...
export { QueryParamsResponse, QueryAllValidatorSetResponse, QueryAllGeneralKeyShareRequest, CurrentKeysPacketData, MsgRegisterValidator, KeyShare, MsgCreateLatestPubKey, MsgCreateAuthorizedAddress, QueryGetAggregatedKeyShareRequest, QueryAllAggregatedKeyShareRequest, GenesisState, MsgCreateLatestPubKeyResponse, MsgCreateGeneralKeyShare, CounterPartyIBCInfo, ValidatorEncryptedKeyShare, GetPrivateKeysharePacketAck, GeneralKeyShare, QueryAllKeyShareResponse, GetAggrKeysharePacketAck, QueryGetValidatorSetRequest, ValidatorSet, QueryVerifiableRandomnessResponse, QueryGetValidatorSetResponse, RequestAggrKeysharePacketData, IBCInfo, QueryGetAuthorizedAddressResponse, RequestPrivateKeysharePacketData, MsgUpdateParams, MsgUpdateAuthorizedAddressResponse, Params, QueryAllValidatorSetRequest, QueryGetGeneralKeyShareRequest, MsgCreateGeneralKeyShareResponse, MsgUpdateAuthorizedAddress, PrivateKeyshareRequest, QueryVerifiableRandomnessQuery, QueryAllAggregatedKeyShareResponse, QueryGetGeneralKeyShareResponse, EncryptedKeysharesPacketData, MsgSendKeyshareResponse, MsgDeleteAuthorizedAddressResponse, KeyShareRequest, MsgRegisterValidatorResponse, EncryptedKeyShare, ActivePubKey, QueryAllKeyShareRequest, QueryAllAuthorizedAddressResponse, Commitments, QueryParamsRequest, QueryGetAggregatedKeyShareResponse, MsgSubmitEncryptedKeyshareResponse, CurrentKeysPacketAck, QueuedPubKey, QueryAllGeneralKeyShareResponse, AggrKeyshareDataPacketData, AggrKeyshareDataPacketAck, QueryAllAuthorizedAddressRequest, QueryPubKeyResponse, MsgDeRegisterValidatorResponse, GetPrivateKeysharePacketData, KeysharePacketData, NoData, QueryPubKeyRequest, AuthorizedAddress, MsgOverrideLatestPubKey, MsgOverrideLatestPubKeyResponse, AggregatedKeyShare, QueryGetKeyShareRequest, MsgSubmitEncryptedKeyshare, QueryGetKeyShareResponse, QueryGetAuthorizedAddressRequest, MsgUpdateParamsResponse, GetAggrKeysharePacketData, MsgSendKeyshare, QueryCommitmentsRequest, QueryCommitmentsResponse, RequestPrivateKeysharePacketAck, RequestAggrKeysharePacketAck, EncryptedKeysharesPacketAck, MsgDeleteAuthorizedAddress, MsgCreateAuthorizedAddressResponse, MsgDeRegisterValidator };
...
type sendGetPrivateKeysharePacketAckParams = {
  value: GetPrivateKeysharePacketAck,
  fee?: StdFee,
  memo?: string
};
...
type sendRequestPrivateKeysharePacketDataParams = {
...
type sendPrivateKeyshareRequestParams = {
  value: PrivateKeyshareRequest,
  fee?: StdFee,
  memo?: string
};
...
type sendEncryptedKeysharesPacketDataParams = {
...
type sendGetPrivateKeysharePacketDataParams = {
...
type sendRequestPrivateKeysharePacketAckParams = {
  value: RequestPrivateKeysharePacketAck,
  fee?: StdFee,
  memo?: string
};
...
type sendEncryptedKeysharesPacketAckParams = {
  value: EncryptedKeysharesPacketAck,
  fee?: StdFee,
  memo?: string
};
...
type getPrivateKeysharePacketAckParams = {
  value: GetPrivateKeysharePacketAck,
};
...
type requestPrivateKeysharePacketDataParams = {
  value: RequestPrivateKeysharePacketData,
};
...
type privateKeyshareRequestParams = {
  value: PrivateKeyshareRequest,
};
...
type encryptedKeysharesPacketDataParams = {
  value: EncryptedKeysharesPacketData,
};
...
type getPrivateKeysharePacketDataParams = {
  value: GetPrivateKeysharePacketData,
};
...
type requestPrivateKeysharePacketAckParams = {
  value: RequestPrivateKeysharePacketAck,
};
...
type encryptedKeysharesPacketAckParams = {
  value: EncryptedKeysharesPacketAck,
};
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		async sendGetPrivateKeysharePacketAck({ value, fee, memo }: sendGetPrivateKeysharePacketAckParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendGetPrivateKeysharePacketAck: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.getPrivateKeysharePacketAck({ value: GetPrivateKeysharePacketAck.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendGetPrivateKeysharePacketAck: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendRequestPrivateKeysharePacketData({ value, fee, memo }: sendRequestPrivateKeysharePacketDataParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendRequestPrivateKeysharePacketData: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.requestPrivateKeysharePacketData({ value: RequestPrivateKeysharePacketData.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendRequestPrivateKeysharePacketData: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendPrivateKeyshareRequest({ value, fee, memo }: sendPrivateKeyshareRequestParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendPrivateKeyshareRequest: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.privateKeyshareRequest({ value: PrivateKeyshareRequest.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendPrivateKeyshareRequest: Could not broadcast Tx: '+ e.message)
			}
		},
		
		async sendQueryVerifiableRandomnessQuery({ value, fee, memo }: sendQueryVerifiableRandomnessQueryParams): Promise<DeliverTxResponse> {
			if (!signer) {
		...
		async sendEncryptedKeysharesPacketData({ value, fee, memo }: sendEncryptedKeysharesPacketDataParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendEncryptedKeysharesPacketData: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.encryptedKeysharesPacketData({ value: EncryptedKeysharesPacketData.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendEncryptedKeysharesPacketData: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendGetPrivateKeysharePacketData({ value, fee, memo }: sendGetPrivateKeysharePacketDataParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendGetPrivateKeysharePacketData: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.getPrivateKeysharePacketData({ value: GetPrivateKeysharePacketData.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendGetPrivateKeysharePacketData: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendRequestPrivateKeysharePacketAck({ value, fee, memo }: sendRequestPrivateKeysharePacketAckParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendRequestPrivateKeysharePacketAck: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.requestPrivateKeysharePacketAck({ value: RequestPrivateKeysharePacketAck.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendRequestPrivateKeysharePacketAck: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		async sendEncryptedKeysharesPacketAck({ value, fee, memo }: sendEncryptedKeysharesPacketAckParams): Promise<DeliverTxResponse> {
			if (!signer) {
					throw new Error('TxClient:sendEncryptedKeysharesPacketAck: Unable to sign Tx. Signer is not present.')
			}
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry});
				let msg = this.encryptedKeysharesPacketAck({ value: EncryptedKeysharesPacketAck.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
				throw new Error('TxClient:sendEncryptedKeysharesPacketAck: Could not broadcast Tx: '+ e.message)
			}
		},
		...
		getPrivateKeysharePacketAck({ value }: getPrivateKeysharePacketAckParams): EncodeObject {
			try {
				return { typeUrl: "/fairyring.keyshare.GetPrivateKeysharePacketAck", value: GetPrivateKeysharePacketAck.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:GetPrivateKeysharePacketAck: Could not create message: ' + e.message)
			}
		},
		...
		requestPrivateKeysharePacketData({ value }: requestPrivateKeysharePacketDataParams): EncodeObject {
			try {
				return { typeUrl: "/fairyring.keyshare.RequestPrivateKeysharePacketData", value: RequestPrivateKeysharePacketData.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:RequestPrivateKeysharePacketData: Could not create message: ' + e.message)
			}
		},
		...
		privateKeyshareRequest({ value }: privateKeyshareRequestParams): EncodeObject {
			try {
				return { typeUrl: "/fairyring.keyshare.PrivateKeyshareRequest", value: PrivateKeyshareRequest.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:PrivateKeyshareRequest: Could not create message: ' + e.message)
			}
		},
		
		queryVerifiableRandomnessQuery({ value }: queryVerifiableRandomnessQueryParams): EncodeObject {
			try {
				return { typeUrl: "/fairyring.keyshare.QueryVerifiableRandomnessQuery", value: QueryVerifiableRandomnessQuery.fromPartial( value ) }  
			} catch (e: any) {
		...
		encryptedKeysharesPacketData({ value }: encryptedKeysharesPacketDataParams): EncodeObject {
			try {
				return { typeUrl: "/fairyring.keyshare.EncryptedKeysharesPacketData", value: EncryptedKeysharesPacketData.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:EncryptedKeysharesPacketData: Could not create message: ' + e.message)
			}
		},
		...
		getPrivateKeysharePacketData({ value }: getPrivateKeysharePacketDataParams): EncodeObject {
			try {
				return { typeUrl: "/fairyring.keyshare.GetPrivateKeysharePacketData", value: GetPrivateKeysharePacketData.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:GetPrivateKeysharePacketData: Could not create message: ' + e.message)
			}
		},
		...
		requestPrivateKeysharePacketAck({ value }: requestPrivateKeysharePacketAckParams): EncodeObject {
			try {
				return { typeUrl: "/fairyring.keyshare.RequestPrivateKeysharePacketAck", value: RequestPrivateKeysharePacketAck.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:RequestPrivateKeysharePacketAck: Could not create message: ' + e.message)
			}
		},
		...
		encryptedKeysharesPacketAck({ value }: encryptedKeysharesPacketAckParams): EncodeObject {
			try {
				return { typeUrl: "/fairyring.keyshare.EncryptedKeysharesPacketAck", value: EncryptedKeysharesPacketAck.fromPartial( value ) }  
			} catch (e: any) {
				throw new Error('TxClient:EncryptedKeysharesPacketAck: Could not create message: ' + e.message)
			}
		},
