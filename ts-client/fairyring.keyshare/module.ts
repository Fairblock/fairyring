...
import { RequestPrivateKeysharePacketData as typeRequestPrivateKeysharePacketData} from "./types"
import { RequestPrivateKeysharePacketAck as typeRequestPrivateKeysharePacketAck} from "./types"
import { EncryptedKeysharesPacketData as typeEncryptedKeysharesPacketData} from "./types"
import { EncryptedKeysharesPacketAck as typeEncryptedKeysharesPacketAck} from "./types"

export { AuthorizedAddress, AggrKeyshareDataPacketData, MsgDeleteAuthorizedAddress, MsgSendKeyshare, MsgSendKeyshareResponse, CurrentKeysPacketData, EncryptedKeyShare, MsgDeRegisterValidatorResponse, QueryGetKeyShareResponse, QueryPubKeyRequest, QueryGetAuthorizedAddressRequest, MsgOverrideLatestPubKeyResponse, MsgDeleteAuthorizedAddressResponse, MsgUpdateAuthorizedAddress, NoData, QueryCommitmentsResponse, QueryParamsResponse, QueryPubKeyResponse, QueryGetAuthorizedAddressResponse, QueryAllAuthorizedAddressResponse, QueryGetGeneralKeyShareResponse, GeneralKeyShare, QueryVerifiableRandomnessQuery, Commitments, AggrKeyshareDataPacketAck, QueryParamsRequest, ActivePubKey, GetAggrKeysharePacketAck, MsgDeRegisterValidator, MsgCreateAuthorizedAddressResponse, RequestAggrKeysharePacketAck, QueryGetKeyShareRequest, MsgUpdateParamsResponse, MsgCreateGeneralKeyShare, IBCInfo, MsgCreateLatestPubKey, QueryAllAggregatedKeyShareRequest, QueryAllValidatorSetResponse, QueryGetGeneralKeyShareRequest, MsgCreateGeneralKeyShareResponse, KeyShare, MsgOverrideLatestPubKey, QueryAllValidatorSetRequest, QueryVerifiableRandomnessResponse, MsgRegisterValidatorResponse, GenesisState, MsgRegisterValidator, KeysharePacketData, MsgCreateLatestPubKeyResponse, KeyShareRequest, RequestAggrKeysharePacketData, QueryGetValidatorSetResponse, QueryAllKeyShareRequest, CounterPartyIBCInfo, GetAggrKeysharePacketData, QueryGetValidatorSetRequest, QueryAllKeyShareResponse, MsgUpdateParams, CurrentKeysPacketAck, QueryCommitmentsRequest, QueryGetAggregatedKeyShareRequest, QueryAllAggregatedKeyShareResponse, QueryAllAuthorizedAddressRequest, QueryAllGeneralKeyShareRequest, QueryAllGeneralKeyShareResponse, AggregatedKeyShare, MsgUpdateAuthorizedAddressResponse, ValidatorSet, QueuedPubKey, MsgCreateAuthorizedAddress, Params, QueryGetAggregatedKeyShareResponse };
...
class SDKModule {
	...
	constructor(client: IgniteClient) {		
		...
		this.structure =  {
						RequestPrivateKeysharePacketData: getStructure(typeRequestPrivateKeysharePacketData.fromPartial({})),
						RequestPrivateKeysharePacketAck: getStructure(typeRequestPrivateKeysharePacketAck.fromPartial({})),
						EncryptedKeysharesPacketData: getStructure(typeEncryptedKeysharesPacketData.fromPartial({})),
						EncryptedKeysharesPacketAck: getStructure(typeEncryptedKeysharesPacketAck.fromPartial({})),
