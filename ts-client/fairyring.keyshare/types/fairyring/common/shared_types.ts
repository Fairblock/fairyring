...
export interface RequestPrivateKeyshare {
  creator: string;
  requestId: string;
}
...
function createBaseRequestPrivateKeyshare(): RequestPrivateKeyshare {
  return { creator: "", requestId: "" };
}

export const RequestPrivateKeyshare = {
  encode(message: RequestPrivateKeyshare, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RequestPrivateKeyshare {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseRequestPrivateKeyshare();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): RequestPrivateKeyshare {
    return {
      creator: isSet(object.creator) ? globalThis.String(object.creator) : "",
  ...
  toJSON(message: RequestPrivateKeyshare): unknown {
    const obj: any = {};
    if (message.creator !== "") {
      obj.creator = message.creator;
    }
  ...
  create<I extends Exact<DeepPartial<RequestPrivateKeyshare>, I>>(base?: I): RequestPrivateKeyshare {
    return RequestPrivateKeyshare.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<RequestPrivateKeyshare>, I>>(object: I): RequestPrivateKeyshare {
    const message = createBaseRequestPrivateKeyshare();
    message.creator = object.creator ?? "";
