...
function createBaseMsgRequestPrivateIdentity(): MsgRequestPrivateIdentity {
  return { creator: "", reqId: "", amount: undefined };
}
...
export const MsgGetPrivateKeyshares = {
  encode(message: MsgGetPrivateKeyshares, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.creator !== "") {
      writer.uint32(10).string(message.creator);
    }
    if (message.reqId !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): MsgGetPrivateKeyshares {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
  ...
  fromJSON(object: any): MsgGetPrivateKeyshares {
    return {
      creator: isSet(object.creator) ? globalThis.String(object.creator) : "",
      reqId: isSet(object.reqId) ? globalThis.String(object.reqId) : "",
    };
  ...
  toJSON(message: MsgGetPrivateKeyshares): unknown {
    const obj: any = {};
    if (message.creator !== "") {
      obj.creator = message.creator;
    }
  ...
  create<I extends Exact<DeepPartial<MsgGetPrivateKeyshares>, I>>(base?: I): MsgGetPrivateKeyshares {
    return MsgGetPrivateKeyshares.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgGetPrivateKeyshares>, I>>(object: I): MsgGetPrivateKeyshares {
    const message = createBaseMsgGetPrivateKeyshares();
    message.creator = object.creator ?? "";
    message.reqId = object.reqId ?? "";
    return message;
...
function createBaseMsgGetPrivateKeysharesResponse(): MsgGetPrivateKeysharesResponse {
  return {};
}

export const MsgGetPrivateKeysharesResponse = {
  encode(_: MsgGetPrivateKeysharesResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): MsgGetPrivateKeysharesResponse {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseMsgGetPrivateKeysharesResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
      }
  ...
  fromJSON(_: any): MsgGetPrivateKeysharesResponse {
    return {};
  },

  toJSON(_: MsgGetPrivateKeysharesResponse): unknown {
    const obj: any = {};
    return obj;
  },

  create<I extends Exact<DeepPartial<MsgGetPrivateKeysharesResponse>, I>>(base?: I): MsgGetPrivateKeysharesResponse {
    return MsgGetPrivateKeysharesResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgGetPrivateKeysharesResponse>, I>>(_: I): MsgGetPrivateKeysharesResponse {
    const message = createBaseMsgGetPrivateKeysharesResponse();
    return message;
  },
};
...
export interface Msg {
  ...
  GetPrivateKeyshares(request: MsgGetPrivateKeyshares): Promise<MsgGetPrivateKeysharesResponse>;
}
...
export class MsgClientImpl implements Msg {
  ...
  constructor(rpc: Rpc, opts?: { service?: string }) {
    ...
    this.GetPrivateKeyshares = this.GetPrivateKeyshares.bind(this);
  }
  UpdateParams(request: MsgUpdateParams): Promise<MsgUpdateParamsResponse> {
  ...
  GetPrivateKeyshares(request: MsgGetPrivateKeyshares): Promise<MsgGetPrivateKeysharesResponse> {
    const data = MsgGetPrivateKeyshares.encode(request).finish();
    const promise = this.rpc.request(this.service, "GetPrivateKeyshares", data);
    return promise.then((data) => MsgGetPrivateKeysharesResponse.decode(_m0.Reader.create(data)));
  }
}
