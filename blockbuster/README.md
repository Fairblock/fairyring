...
implementations of lanes: top of block lane, free lane, and a default lane.
    ...
    fees. What qualifies as a free transaction is determined
     [here](https://fairyring/blob/main/blockbuster/lanes/free/factory.go).
...
The general interface that each lane must implement can be found [here](https://fairyring/blob/main/blockbuster/lane.go):
