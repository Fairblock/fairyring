...
./scripts/tests/lazychain/keyshareSender.sh $BINARY $CHAIN_DIR/$CHAINID_1 tcp://localhost:16657 $VALIDATOR_1 $CHAINID_1 > $CHAIN_DIR/keyshareSender.log 2>&1 &
...
./scripts/tests/lazychain/pep.sh $GENERATED_SHARE