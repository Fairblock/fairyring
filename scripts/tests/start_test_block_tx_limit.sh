...
for i in $(seq 0 $(($TOTAL_TEST_ACC_NUM-1)))
do
 $BINARY add-genesis-account "test$i" 1000000000000frt --home $CHAIN_DIR/$CHAINID_1
done
...
$BINARY add-genesis-account $NORMALTXACC_ADDR 1000000000000frt --home $CHAIN_DIR/$CHAINID_1
